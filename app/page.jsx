    ...
    <>
      ...
      <main>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="flex items-center justify-between h-12 sm:h-14 gap-2">
              <div className="flex items-center gap-1 overflow-x-auto no-scrollbar shrink min-w-0">
                {["Activities", "Rewards", "Announcements"].map((tab, i) => (
                  <button key={tab} className={`px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium rounded-lg whitespace-nowrap transition ${i === 0 ? "bg-brand-50 text-brand" : "text-muted hover:text-text hover:bg-surface2"}`}>
                    {tab}
                  </button>
                ))}
              </div>
        ...
        <section className="mx-auto max-w-6xl px-4 sm:px-6 pt-6">
          <div className="rounded-2xl bg-white border border-border/60 shadow-card px-4 sm:px-6 py-4 sm:py-5 flex items-center justify-between gap-3">
            <div className="min-w-0">
              <h2 className="font-display text-sm sm:text-base font-semibold">How it works</h2>
              <p className="text-xs sm:text-sm text-muted">Check this post to learn more about platform.</p>
            </div>
            <div className="flex items-center gap-1.5 shrink-0">
              <div className="w-8 sm:w-10 h-2 rounded-full bg-brand" />
            ...
            <div className="px-4 sm:px-6 pb-5 sm:pb-6 -mt-10 sm:-mt-12 relative z-10">
              ...
              <div className="mt-4 sm:mt-5 grid grid-cols-3 gap-2 sm:gap-3">
                <div className="rounded-xl bg-surface2 border border-border/40 px-2 sm:px-4 py-2.5 sm:py-3 text-center">
                  ...
                  <div className="font-display font-bold text-base sm:text-lg mt-0.5">1,500</div>
                </div>
                <div className="rounded-xl bg-surface2 border border-border/40 px-2 sm:px-4 py-2.5 sm:py-3 text-center">
              ...
              <div className="mt-3 sm:mt-4 flex flex-wrap gap-2">
                <button className="btn-secondary text-[11px] sm:text-xs px-2.5 sm:px-3 py-1.5 sm:py-2">Invite Friends &middot; +300XP</button>
          ...
          <div className="rounded-2xl bg-white border border-border/60 shadow-card overflow-hidden">
            ...
            <div className="divide-y divide-border/40">
              {[
                ...
                { rank: "12", name: "You", points: "1500", isYou: true },
              ].map((r, i) => (
                ...
                <div className="p-4">
                  {card.image ? (
                    ...
                    <div className="space-y-2 mb-3">
                      ...
                      {["1. D6", "2. C6", "3. A5", "4. Bb4"].map((opt, j) => (
                        <div key={j} className="text-xs text-muted px-3 py-2 rounded-lg border border-border/60 hover:border-brand/30 cursor-pointer transition">{opt}</div>
                      ))}
                    </div>
                  )}
                  {card.image && (
            ...
            {[
              ...
              <div key={i} className="card overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <button className="w-full mt-3 py-2.5 rounded-xl bg-brand text-white text-sm font-semibold hover:bg-brand-600 transition">{card.cta}</button>
                </div>
